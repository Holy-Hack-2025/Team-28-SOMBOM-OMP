...
# Adding supply chain transactions (e.g., Product Transfer, Recycling)
supply_chain.add_block("Product A manufactured")
supply_chain.add_block("Product A shipped to distributor")
supply_chain.add_block("Product A sent for recycling")
